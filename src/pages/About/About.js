    ...
    return (
        <>
            ...
            <div className="About_container">
                ...
                <p className="About_blurb">Before starting the application process for School of Code, the only time I'd seen HTML had been a brief dabble changing the text and images on a website someone made for me when I was about sixteen; so to say the bootcamp was an extreme learning experience is an understatement!</p>
                <p className="About_blurb">Though it might have been a circuitous route into tech - via football memberships, insurance, and finance - I wouldn't have it any other way. I feel like I'm exactly where I'm supposed to be right now and I'm looking forward to a future working in a field I love.</p>
